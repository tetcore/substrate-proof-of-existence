...
import { DigestTag, FileDigestBond } from "./FileDigestBond";
          ...
          <InputBond
            ...
            action={
              <Button
                content="Another"
                onClick={() =>
                  this.seed.trigger(secretStore().generateMnemonic())
                }
              />
            }
            iconPosition="left"
          ...
          <Segment style={{ margin: "1em" }} padded>
            <Header as="h2">
              ...
              <Header.Content>
                Poke
                <Header.Subheader>
                  Set a particular key of storage to a particular value
                </Header.Subheader>
              </Header.Content>
            </Header>
            <div style={{ paddingBottom: "1em" }} />
                ...
                call: calls.sudo
                  ? calls.sudo.sudo(
                      calls.consensus.setStorage([
                        [
                          this.storageKey.map(hexToBytes),
                          this.storageValue.map(hexToBytes)
                        ]
                      ])
                    )
                  : null
...
class POESegment extends React.Component {
  constructor() {
    super();

    this.poeAccount = new Bond();
    this.poeDigest = new Bond();
  }
      ...
      <Segment style={{ margin: "1em" }} padded>
        <Header as="h2">
          ...
          <Header.Content>
            Proof of Existence
            <Header.Subheader>
              Claim ownership of your digital files
            </Header.Subheader>
          </Header.Content>
        </Header>
        <div style={{ paddingBottom: "1em" }}>
          ...
          <If
            condition={this.poeAccount.ready()}
            then={
              <span>
                <Label>
                  Balance
        ...
        <div>
          ...
          <DigestTag
            value={runtime.poe.proofs(this.poeDigest)}
            account={this.poeAccount}
          />
        </div>
        <TransactButton
          content="Claim File"
          ...
          tx={{
            ...
            call: calls.poe.createClaim(this.poeDigest)
          }}
        />
      </Segment>
    );
