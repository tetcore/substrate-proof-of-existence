...
use proof_of_existence_runtime::{self, GenesisConfig, opaque::Block, ClientWithApi};
...
native_executor_instance!(
	...
	include_bytes!("../runtime/wasm/target/wasm32-unknown-unknown/release/proof_of_existence_runtime.compact.wasm")
);
